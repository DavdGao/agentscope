...
class HumanApproval:
    ...
    async def reply_stream(  # pylint: disable=unused-argument
        ...
        if not isinstance(inputs, ExternalExecutionResultEvent):
                ...
                questions=[
                    {
                        ...
                        "options": [
                            {
                                "label": "Approve",
                                "description": "Hand it on to the next step.",
                            },
                            {
                                "label": "Send back",
                                "description": (
                                    "Say what should change; the step tries "
                                    "again."
                                ),
                            },
                        ],
            ...
            # A reply of its own, announced the way an agent announces a
            # tool call, so the question and the answer land in one bubble
            # under this name.
